...
const links = [
  ...
  { to: "/insights", label: "Security Insights", icon: ShieldCheck },
  ...
  return (
    <>
      ...
      <aside className={`sidebar ${mobileOpen ? "sidebar-open" : ""}`} aria-label="Primary navigation">
        <div className="brand">
          <div className="brand-mark"><BrandMark size={19} /></div>
          <div><strong>ScamShield AI</strong><span>Signal Intelligence</span></div>
          <button className="sidebar-close" onClick={onClose} aria-label="Close navigation"><X size={17} /></button>
        </div>
        ...
        <div className="protection" title="Protection services are enabled">
